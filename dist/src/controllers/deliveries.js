...
exports.getUserDeliveries = exports.getCourierDeliveries = exports.updateDelivery = exports.getDelivery = exports.deleteDelivery = exports.createDelivery = void 0;
const delivery_1 = require("../models/delivery");
const socketio_1 = require("./helpers/socketio");
const createDelivery = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, socketio_1.watchDeliveryChanges)(savedDelivery._id);
